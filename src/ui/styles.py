...
QLabel#FieldLabel { color: #9fb0c1; font-size: 12px; }
...
QLineEdit:focus { border: 1px solid #3a84ff; }
...
QPushButton#PrimaryBtn { background: #1f7aec; color: white; border: 1px solid #1b65c2; }
QPushButton#PrimaryBtn:hover { background: #2a86ff; }

QPushButton#SecondaryBtn { background: #141a23; color: #cbd5e1; border: 1px solid #2b3a4d; }
QPushButton#SecondaryBtn:hover { border-color: #3a84ff; color: #e6edf3; }

QPushButton#GhostBtn { background: transparent; color: #93a6bb; border: 1px solid #2b3a4d; }
...
/* Modern Tabs (used only on the model-building stage) */
#ModernTabs::pane { border: none; padding-top: 4px; }
#ModernTabs QTabBar { qproperty-drawBase: 0; font-size: 12px; }
#ModernTabs QTabBar::tab {
    background: #0b0f14; color: #b8c5d4;
    border: 1px solid #1c2634; border-radius: 12px;
    padding: 8px 16px; margin-right: 8px; margin-top: 6px;
    font-weight: 600; letter-spacing: 0.1px;
}
#ModernTabs QTabBar::tab:selected {
    background: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0,
        stop:0 #2b9bff, stop:1 #6a5cff);
    color: white; border: 1px solid #2f6ee9;
}
#ModernTabs QTabBar::tab:!selected:hover { border-color: #3a84ff; color: #dbe6f3; }
#ModernTabs QTabBar::tab:disabled { color: #6b7d91; border-color: #1a2330; }
